// import { closeSuccessModal } from "../SendEmail";
interface SuccessProps {
  closeModal: () => void;
}

const SuccessModal: React.FC<SuccessProps> = ({ closeModal }) => {
  closeModal();

  return (
    <div>
      <div id="successModal" className="fixed inset-0 z-50 hidden">
            ...
            <div className="mb-3 text-center sm:mt-5">
              ...
              <div className="mt-2">
                <p className="text-lg text-gray-700">
                  Please fill out all required fields. <br></br>Thank You.
                </p>
              </div>
            </div>
